...
[Click here to read the narrative detailing the process of enhancing this artifact](CS 499 Script Document.docx)
...
Specifically, this artifact is meant to support and showcase my skills in Course Outcome One in my Computer Science Captsone Course. This Course Outcome states "Employ strategies for building collaborative environments that enable diverse audiences to support organizational decision-making in the field of computer science.". The Text Based Game, now that it has been enhanced, is all about reaching a wider audience. Having different levels of difficulty, various ways to end the game, and new ways to interact with the game, all allow for a wider audience to be reached. As such, the enhanced design and functionality of this game is meant to promot collaboration amongst players, accessibility to a more diverse audience of players, and support from both a program side with increased error handling and player side with different ways the player can end the game.

Additionally, this artifact also meets the Course Outcome Number Four, which states "Demonstrate an ability to use well-founded and innovative techniques, skills, and tools in computing practices for the purpose of implementing computer solutions that deliver value and accomplish industry-specific goals." In loading in the image of the map for the easier difficulty setting of the game, I implemented Python image handling libraries. This showcases my ability to consider available resources and tools that could be used to implement a computer solution that accomplishes the goal of making the game more accessible to a wider audience. Having implemented this tool, I also showcase my innovative skills to integrate additional libraries and file loading systems into an existing code that I had written a while ago. 
