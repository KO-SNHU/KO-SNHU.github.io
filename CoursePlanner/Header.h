...
public: // This begins the section where the public terms will be declared
	...
	string getNumber() const { // This declares the string getter function getNumber
		return courseNumber; // This returns courseNumber
	}

	string getName() const { // This declares the string getter function getName
		return courseName; // This returns courseName
	}

	vector<string> getPrerequisites() const { // This declares the vector of strings getter function getPrerequisites
